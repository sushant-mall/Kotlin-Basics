...
//
//fun main(){
//    var samsung = Mobilephone("Oreo","Samsung","s10")
//    var oneplus = Mobilephone("pie","One Plus","8pro")
//    var apple = Mobilephone("ios10","Iphone","11ProMax")
//
//}
// class Mobilephone(osname:String,brand:String,model:String){
//     init {
//         println("The phone $model from $brand use $osname as its operating system")
//     }
// }
